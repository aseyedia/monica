...
return [
    ...
    'stay_in_touch_last_contacted' => 'Last contacted: {date}',
    'stay_in_touch_never_contacted' => 'Never marked as contacted',
    ...
    'stay_in_touch_modal_unit_days' => 'days',
    'stay_in_touch_modal_unit_weeks' => 'weeks',
    'stay_in_touch_modal_unit_months' => 'months',
    'stay_in_touch_modal_start_date' => 'Start cycle from (optional)',
    'stay_in_touch_modal_start_date_hint' => 'Leave blank to start from today. Set to a past date if you already contacted them recently.',
    'stay_in_touch_mark_contacted' => 'Contacted today',
    'stay_in_touch_mark_contacted_success' => 'Marked as contacted. Next reminder reset.',
    'stay_in_touch_snooze' => 'Snooze {days} days',
    'stay_in_touch_snoozed' => 'Snoozed. Next reminder pushed to {date}.',

    // Calls
    'modal_call_title' => 'Log a call or text',
    'modal_call_comment' => 'What did you talk about? (optional)',
    'modal_call_exact_date' => 'The phone call happened on',
    'modal_call_text_date' => 'The text exchange happened on',
    'modal_call_who_called' => 'Who called?',
    'modal_call_emotion' => 'Do you want to log how you felt? (optional)',
    'calls_add_success' => 'Saved successfully.',
    'call_delete_confirmation' => 'Are you sure you want to delete this?',
    'call_delete_success' => 'Deleted successfully.',
    'call_title' => 'Calls & texts',
    'call_empty_comment' => 'No details',
    'call_blank_title' => 'Keep track of the calls and texts done with {name}',
